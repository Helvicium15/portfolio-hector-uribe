...
function DockItem({
    ...
    return (
        <motion.button
            ...
            whileTap={{ scale: 0.9 }}
        >
            {/* Icon Container — transparent; icon provides its own glass background */}
            <motion.div
                className="relative w-full h-full rounded-[inherit] overflow-hidden flex items-center justify-center"
            >
                {/* Full-size icon slot */}
                ...
                {showLabels && isHovered && (
                    <motion.div
                        ...
                        style={{
                            ...
                            color: 'rgba(226,226,224,0.90)',
                            border: '0.5px solid rgba(131,202,226,0.28)',
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                background: 'rgba(15,41,64,0.92)',
                                borderRight: '0.5px solid rgba(131,202,226,0.28)',
                                borderBottom: '0.5px solid rgba(131,202,226,0.28)',
                            }}
                        />
                    </motion.div>
                )}
